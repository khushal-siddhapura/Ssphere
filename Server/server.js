...
const topProductsRoutes = require("./routes/admin/topProducts-routes");
const salesByCategoryRotes = require("./routes/admin/salesByCategory-routes");
...
app.use(
  cors({
    origin: "https://ssphere-e-commerce-company.vercel.app/auth/login",
